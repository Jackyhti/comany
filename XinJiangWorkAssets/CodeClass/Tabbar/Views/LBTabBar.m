...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        //post_normal
        [plusBtn setImage:[UIImage imageNamed:@"addBlue"] forState:UIControlStateNormal];
        [plusBtn setImage:[UIImage imageNamed:@"addBlue"] forState:UIControlStateHighlighted];
...
//    //调整发布按钮的中线点Y值
//    self.plusBtn.centerY = self.height * 0.5 - BTNWIDTH * 0.4 ;
//    
//    self.plusBtn.size = CGSizeMake(BTNWIDTH,BTNWIDTH);

    self.plusBtn.frame = CGRectMake(screen_width/2-BTNWIDTH/2, -BTNWIDTH/2, BTNWIDTH, BTNWIDTH);
