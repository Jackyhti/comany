...
@interface XWPublishBaseController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,JJPhotoDelegate,XWImagePickerSheetDelegate>{
...
//    layout.headerReferenceSize = CGSizeMake(kScreen_width, 1);
//    layout.footerReferenceSize = CGSizeMake(kScreen_width, 1);
...
//    [self.pickerCollectionView registerNib:[UINib nibWithNibName:@"XWCollectionFootView" bundle:nil] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"FooterView"];
    
//   [self.pickerCollectionView registerClass:[UICollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"FooterView"];

    
    //使用原有重用视图
//    [self.pickerCollectionView registerClass:[UICollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"HeaderView"];
...
//            if(_isEdit == NO) {
//                [cell setBigImgViewWithImage:_arrSelected[index]];
//
//            }else {
...
//-(void)upframe{
//    if (_arrSelected.count>3) {
//        CGFloat a = [self getPickViewFrameOrginY];
//        NSString *str = [NSString stringWithFormat:@"%f",a];
//        [[NSNotificationCenter defaultCenter]postNotificationName:@"count" object:nil userInfo:@{@"count":str}];
//    }else{
//        
//    }
//}
...
-(CGFloat)getPickViewFrameOrginY{
    return _pickerCollectionView.frame.origin.y;
}
...
//    CGSize size={kScreen_width,1};
//    return size;
//}
//
//
//-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section{
//    CGSize size = {kScreen_width,0};
//    return size;
//}
...
//    {
//        NSLog(@"11");
//        UICollectionReusableView *foot = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"FooterView" forIndexPath:indexPath];
//        reusableView = foot;
