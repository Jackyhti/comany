...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        //radio_unchecked.png
        //radio_checked.png
        [self setImage:[UIImage imageNamed:@"Radio"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"Radio_click"] forState:UIControlStateSelected];
...
- (void)setNomalImg:(UIImage *)nomalImg {
