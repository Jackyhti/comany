...
- (void)show{
    //如果有弹出键盘则window是两个对象，没有弹出键盘则window只有一个对象
...
+ (void)showWithText:(NSString *)text_{
    [LToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    LToast *toast = [[[LToast alloc] initWithText:text_] autorelease];
...
+ (void)showWithText:(NSString *)text_
    ...
    [LToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [LToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
