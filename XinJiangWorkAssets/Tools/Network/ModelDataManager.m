...
//
//
//  Created by sunbo on 14-6-26.
//  Copyright (c) 2017年 sunbo. All rights reserved.
//
...
// 单例类的静态实例对象，因为对象需要唯一性，故只能是static类型
static ModelDataManager *sharedManager = nil;
 ...
 *
 *  @brief  单例模式对外的唯一接口，用到的dispatch_once函数在一个应用程序内只会执行一次，且dispatch_once能确保线程安全
 *
 *  @return 模型对象
 */
