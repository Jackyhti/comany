...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL ret = [_mapManager start:@"gq5f5MFHOCjlX6fO9LuRYx8bI8k8eiTT"  generalDelegate:nil];
    if (!ret) {
        NSLog(@"manager start failed!");
    }
    
    
    [self addPush:launchOptions];
    ...
    LoginViewController *barVC = [[LoginViewController alloc] init];
    
    
    
//    [LaunchIntroductionView sharedWithImages:@[@"qdy_0",@"qdy_1",@"qdy_2"]];
    
    if ([[UserInfoManager shareGlobalSettingInstance] getUserInfo][@"data"][@"LeaderID"]) {
        //自动登录
        [self aotuLogin];
        [self setUser];
    ...
    //更改头像
      [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(reload) name:@"header" object:nil];
    //更改个人信息
...
-(void)addPush:(NSDictionary*)launch{
    //Required
    ...
    [JPUSHService setupWithOption:launch appKey:@"c09fce9e9b1a56ac06b1b6e3"
                          channel:channel
...
didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
    NSLog(@"%@", [NSString stringWithFormat:@"极光推送----Device Token: %@", deviceToken]);
